    ...
    items: [
      {
        ...
        reps: '6-8',
        restSeconds: 120,
        notes: 'Mantén 2 reps en reserva y controla la bajada.',
      },
      {
        id: 'push-2',
        ...
        reps: '8-10',
        restSeconds: 90,
        notes: 'Recorrido completo, sin bloquear codos.',
      },
    ...
    items: [
      {
        ...
        reps: '6-8',
        restSeconds: 120,
        notes: 'Evita balanceo, pausa 1s en contracción.',
      },
    ...
    items: [
      {
        ...
        reps: '5-6',
        restSeconds: 150,
        notes: 'Calentamiento progresivo antes del peso de trabajo.',
      },
